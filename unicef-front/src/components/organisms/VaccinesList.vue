    ...
    <div class="mt-16 flex bg-[#F8F9FB]" v-else>
      ...
      <div class="-mt-16 flex flex-col pt-20">
        ...
        <div class="flex justify-end">
          <div class="my-auto">
            <Button type="submit" class="w-full justify-center gap-2 rounded-full" v-slot="{ iconSizeClasses }">
              <PlusCircleIcon aria-hidden="true" :class="iconSizeClasses" />
              <span class="mx-auto px-2 text-sm uppercase tracking-widest">{{
                $t('patient-details.add-vaccine')
              }}</span>
            </Button>
          </div>
