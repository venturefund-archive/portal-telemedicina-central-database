<template>
  <div class="relative">
    <button
      ...
      class="group border-r-1 border-l-1 inline-flex items-center justify-center gap-2 border border-gray-100 border-b-transparent border-t-transparent px-4 py-2"
    >
