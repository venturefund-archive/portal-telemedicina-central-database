    ...
    >
      <InputIconWrapper>
        ...
        <Input
          ...
          withIcon
          required
          class="mb-3 block w-full rounded-lg border border-gray-200 border-transparent bg-gray-50 p-4 pl-10 text-sm font-medium text-gray-900 focus:ring-0 focus:border-green-500"
        />
      </InputIconWrapper>
