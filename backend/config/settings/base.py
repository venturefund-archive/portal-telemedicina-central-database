...
ADMINS = [
    (
        """Guilherme Negrini, Nicholas Drabowski, Rodrigo Polverari""",
        "(g.negrini, nicholas, r.polverari) @portaltelemedicina.com.br",
    )
]
...
try:
    ...
    print("No Google Cloud credentials found. Some features may not work.")
...
USE_FHIR_STORE = env("USE_FHIR_STORE", default=False)
DEFAULT_FHIR_CLIENT = env("DEFAULT_FHIR_CLIENT", default="hapi")
FHIR_APP_ID = env("FHIR_APP_ID", default="di_app")
FHIR_PROJECT_ID = env("FHIR_PROJECT_ID", default="ptm-gestao-di-dev")
FHIR_LOCATION = env("FHIR_LOCATION", default="southamerica-east1")
REDIS_URL = 'redis://localhost:6379/0'
GOOGLE_MAPS_API_KEY = env("GOOGLE_MAPS_API_KEY", default="AIzaSyA6Whf_ujYs2xP5ZNnXqSAl_OigekYW7Ms")