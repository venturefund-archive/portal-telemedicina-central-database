...
class TestPatientViewSet(APITestCase):
    ...
    @mock.patch(
        "patients.api.views.PatientsViewSet.get_queryset"  # noqa: E501
    )
    ...
    @mock.patch(
        "patients.api.views.PatientsViewSet._get_fhir_client"  # noqa: E501
    )
    @mock.patch(
        "patients.api.views.PatientsViewSet.get_queryset"  # noqa: E501
    )
    ...
    @mock.patch(
        "patients.api.views.PatientsViewSet.get_object"  # noqa: E501
    )
...
class TestPatientUpdateViewSet(APITestCase):
    ...
    @mock.patch(
        "patients.api.views.PatientsViewSet.get_object"
    )  # noqa: E501
